        ...
        <div class="col-12 d-flex flex-wrap justify-content-center p-3 mb-5 mt-4">
            <div class="col-md-4 col-11 d-flex justify-content-center align-items-center my-5">
                <div class="col-11 rounded-5 my-5 sign-box pb-2" style="background-color: white;">
                    ...
                    <?php endif; ?>
                    <form action="/SE_Ass_Code/index.php?url=logIn/resetPasswordRequest" method="POST" class="mt-md-5 m-3">
                        <div class="user-box">
                            <input type="texy" id="id" name="id" required>
                            <label for="id">Nhập ID</label>
                        </div>
                            <div class="d-grid">
                                <button type="submit" class="btn btn-dark">
                                    <i class="bi fs-5 bi-send-fill"></i> Gửi
                                </button>
                            </div>
