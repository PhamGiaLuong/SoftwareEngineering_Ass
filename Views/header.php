...
<html lang="en">
    <head>
        ...
        <link href="/SoftwareEngineering_Ass/style.css" rel="stylesheet">
        ...
        <div class="navbar nbar navbar-light fixed-top navbar-expand-lg" style="font-family: 'Signika Negative';">
            <div class="container-fluid">
                <div class="col-3 py-2">
                    <a class="col-12 d-flex navbar-brand" href="/SoftwareEngineering_Ass/index.php?url=home">
                        <div> 
                            <img src="/SoftwareEngineering_Ass/Images/logoVienTrang.png" alt="Logo" width="50px">
                        </div>
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end align-items-center flex-grow-1 pe-3">
                            <li class="nav-item px-2">
                                ...
                                aria-current="page" href="/SoftwareEngineering_Ass/index.php?url=home" data-tab="home">
                                    TRANG CHỦ
                                </a>
                            </li>
                            ...
                            <li class="nav-item px-2">
                                ...
                                href="/SoftwareEngineering_Ass/index.php?url=manage" data-tab="manage">
                                    QUẢN LÝ
                                </a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="nav-item px-2">
                                ...
                                href="/SoftwareEngineering_Ass/index.php?url=admin" data-tab="admin">
                                    QUẢN TRỊ
                                </a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="nav-item px-2">
                                ...
                                href="/SoftwareEngineering_Ass/index.php?url=booking" data-tab="booking">
                                    ĐẶT PHÒNG
                                </a>
                            </li>
                            <li class="nav-item px-2">
                                <a class="nav-link nlink <?php echo ($TAB == "forum") ? "active" : ""; ?>" 
                                href="/SoftwareEngineering_Ass/index.php?url=forum" data-tab="forum">
                            ...
                            <li class="nav-item">
                                <div class="dropdown">
                                    ...
                                    <?php if (isset($_SESSION["Role"])): ?>
                                        <li>
                                            <a class="dropdown-item" href="/SoftwareEngineering_Ass/index.php?url=account" data-tab="account">
                                                Tài khoản
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="/SoftwareEngineering_Ass/index.php?url=history" data-tab="account">
                                                Lịch sử đặt phòng
                                            </a>
                                        </li>
                                    <?php endif; ?>    
                                        <li>
                                            <?php if (isset($_SESSION["userID"])): ?>
                                                <a class="dropdown-item" href="/SoftwareEngineering_Ass/index.php?url=logout" data-tab="account">
                                                    Đăng xuất (<?php echo $_SESSION["userID"]; ?>)
                                                </a>
                                            <?php else: ?>
                                                <a class="dropdown-item" href="/SoftwareEngineering_Ass/index.php?url=loginOption" data-tab="account">
                                                    Đăng nhập
                                                </a>
                                            <?php endif; ?>
                                        </li>
